...
@WebServlet(urlPatterns = {"/student/check-in"})
public final class StudentCheckInPageController extends HttpServlet {

  private static final String VIEW_PATH = "/WEB-INF/views/student/check-in.jsp";
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    request.setAttribute(
        "studentCheckInBootstrapJson",
        jsonPayloadMapper.write(registrationService.getCheckInPage(currentUser.get().userId())));
