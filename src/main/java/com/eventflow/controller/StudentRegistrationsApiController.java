...
@WebServlet("/api/student/registrations")
public final class StudentRegistrationsApiController extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    try {
      ...
      List<RegistrationStatusDto> registrations = registrationService.listUserRegistrations(actor.userId());
      jsonResponseWriter.writeApiResponse(
          response,
          HttpServletResponse.SC_OK,
          ApiResponse.success("Registrations loaded successfully.", registrations));
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    writeFailure(
        ...
        new ApplicationException(
            "Student registrations route was not found.",
            404,
